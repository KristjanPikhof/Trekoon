...
const QUICKSTART_HELP = [
  ...
  "",
  "Primary flow (session-first):",
  "  1) trekoon --toon session",
  "  2) Fail fast on recoveryRequired or tracked/ignored mismatch diagnostics",
  "  3) If behind > 0: trekoon --toon sync pull --from main",
  "  4) Claim work: trekoon --toon task update <task-id> --status in_progress",
  "  5) Mark done: trekoon --toon task done <task-id>",
  "",
...
const EPIC_HELP = [
  ...
  "List behavior:",
  "  Defaults:",
  "    - Open statuses only: in_progress, todo",
  "    - Limit: 10",
  "  Flags:",
...
const SYNC_HELP = [
  ...
  "  (e.g., status, title, description) on one entity (epic, task, or subtask).",
  "",
  ...
  "",
  "  Example: epic status conflict after sync pull --from main",
  "    Entity: epic abc123, field: status",
  "    ours (current DB): in_progress",
  "    theirs (source branch): done",
  "    --use ours  → status stays in_progress",
  "    --use theirs → status becomes done in the live DB",
  "",
  "Compatibility mode:",
...
const SESSION_HELP = [
  ...
  "",
  "Options:",
  "  --epic <epic-id>  Scope readiness to a specific epic instead of the full tracker.",
  "",
  "Output modes:",
...
const SUGGEST_HELP = [
  ...
  "  sync       Behind or pending conflicts",
  "  execution  In-progress or ready tasks",
