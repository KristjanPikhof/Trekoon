...
const TASK_HELP = [
  ...
  "  Escapes in compact specs: \\| for |, \\\\ for \\, \\n, \\r, \\t",
  "  Forgiving input accepted on create/update: --desc normalizes to --description.",
  "  Help examples stay canonical: prefer --description in scripts and docs.",
  "",
  "List:",
  "  Defaults: open work only (in_progress, todo), limit 10.",
...
const DEP_HELP = [
  ...
  "      Forgiving input accepted: --deps, --dependency, --dependencies,",
  "      --dependancy, and --dependancies normalize to --dep.",
