...
const COMMAND_HELP: Record<string, string> = {
  ...
  epic: "Usage: trekoon epic <subcommand> [options] (list supports --view table|compact; show supports --all and --view table|compact|tree|detail)",
  task: "Usage: trekoon task <subcommand> [options] (list supports --view table|compact; show supports --all and --view table|compact|tree|detail)",
