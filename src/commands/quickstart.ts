...
const QUICKSTART_TEXT = [
  ...
  "",
  "2) Bootstrap and fail-fast checks",
  "- 1. Initialize or verify shared storage: trekoon --toon init",
  "- 2. Read machine diagnostics: trekoon --toon sync status",
  "- 3. If diagnostics show recoveryRequired or a tracked/ignored mismatch, stop and repair setup.",
  "- 4. Do not continue after storage mismatch, ambiguous recovery, or broken bootstrap warnings.",
  "- 5. In worktrees, confirm meta.storageRootDiagnostics.sharedStorageRoot matches the repo root.",
  "",
  "3) AI execution loop (deterministic, dependency-aware)",
  "- 1. Confirm diagnostics are clean: trekoon --toon sync status",
