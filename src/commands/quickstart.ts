...
const QUICKSTART_TEXT = [
  ...
  "  and --field <name> narrow the batch. In human mode, single-conflict",
  "  --use theirs prompts with field/value details, while batch --all prompts",
  "  for both ours and theirs using a count-only confirmation (30s timeout,",
  "  defaults to reject).",
  "",
