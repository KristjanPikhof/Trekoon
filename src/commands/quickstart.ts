...
const QUICKSTART_TEXT = [
  ...
  "  - Scope to an epic: trekoon --toon session --epic <epic-id>",
  "- 2. Claim work: trekoon --toon task update <task-id> --status in_progress",
  "- 3. Append progress: trekoon --toon task update <task-id> --append \"Completed implementation\"",
  "- 4. Mark done: trekoon --toon task done <task-id>",
  ...
  "- 5. Or report block: trekoon --toon task update <task-id> --append \"Blocked by <reason>\" --status blocked",
  "",
  ...
  "",
  "5) Orientation and suggestions",
  "- Priority-ranked next-action suggestions: trekoon --toon suggest",
  "- Scoped suggestions: trekoon --toon suggest --epic <epic-id>",
  "- Epic progress dashboard: trekoon --toon epic progress <epic-id>",
  "- Open the local board: trekoon board open",
  "",
  "6) Power-user command patterns (aligned with skill)",
  ...
  "",
  "7) Task details and description",
  "- Human list and show views default to table format.",
  "- Alternate list view: add --view compact.",
  "- task/epic/subtask list defaults: open work only (in_progress, todo), max 10.",
  ...
  "  3. trekoon --toon sync resolve <id> --use theirs --dry-run (preview without mutating)",
  "  4. trekoon --toon sync resolve <id> --use ours|theirs",
  "- In human mode, --use theirs prompts for confirmation (30s timeout, defaults to reject).",
  "- Run sync status again before opening or merging a PR.",
  "",
  "9) Shared-storage wipe warning",
